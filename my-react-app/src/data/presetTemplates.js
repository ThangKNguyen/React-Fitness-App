    ...
    days: [
      {
        ...
        exercises: [
          ...
          { name: 'Bent Over Row', searchQuery: 'bent over barbell row', sets: 3, reps: 8 },
          { name: 'Overhead Shoulder Press', searchQuery: 'barbell overhead press', sets: 3, reps: 8 },
          { name: 'Bicep Curls', searchQuery: 'barbell curl', sets: 3, reps: 10 },
      ...
      },
      {
        ...
        exercises: [
          { name: 'Deadlift', searchQuery: 'deadlift barbell', sets: 3, reps: 5 },
          { name: 'Incline Dumbbell Press', searchQuery: 'incline dumbbell press', sets: 3, reps: 8 },
          { name: 'Lat Pulldown', searchQuery: 'lat pulldown', sets: 3, reps: 8 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: 'Walking Lunges', searchQuery: 'walking lunge', sets: 3, reps: 10 },
          { name: 'Face Pulls', searchQuery: 'face pull', sets: 3, reps: 12 },
    ...
    days: [
      {
        ...
        exercises: [
          { name: 'Bench Press', searchQuery: 'barbell bench press', sets: 4, reps: 5 },
          { name: 'Bent Over Row', searchQuery: 'bent over barbell row', sets: 4, reps: 6 },
          { name: 'Overhead Press', searchQuery: 'barbell overhead press', sets: 3, reps: 6 },
          { name: 'Lat Pulldown', searchQuery: 'lat pulldown', sets: 3, reps: 8 },
          { name: 'Tricep Pushdowns', searchQuery: 'triceps pushdown', sets: 3, reps: 10 },
          { name: 'Bicep Curls', searchQuery: 'barbell curl', sets: 3, reps: 10 },
        ],
      },
      {
        ...
        exercises: [
          ...
          { name: 'Hamstring Curl', searchQuery: 'leg curl', sets: 3, reps: 10 },
          { name: 'Calf Raises', searchQuery: 'calf raise', sets: 3, reps: 12 },
          { name: 'Hanging Leg Raises', searchQuery: 'hanging leg raise', sets: 3, reps: 12 },
        ],
      },
      {
        ...
        exercises: [
          { name: 'Incline Dumbbell Press', searchQuery: 'incline dumbbell press', sets: 3, reps: 8 },
          { name: 'Seated Cable Row', searchQuery: 'cable seated row', sets: 3, reps: 10 },
          { name: 'Dumbbell Shoulder Press', searchQuery: 'dumbbell shoulder press', sets: 3, reps: 8 },
          { name: 'Lateral Raises', searchQuery: 'cable lateral raise', sets: 3, reps: 12 },
          { name: 'Face Pulls', searchQuery: 'face pull', sets: 3, reps: 12 },
          { name: 'Hammer Curls', searchQuery: 'hammer curl', sets: 3, reps: 10 },
          { name: 'Overhead Tricep Extension', searchQuery: 'triceps overhead extension', sets: 3, reps: 10 },
        ],
      },
      {
        label: 'Day 4 – Lower (Hypertrophy)',
        exercises: [
          { name: 'Deadlift', searchQuery: 'deadlift barbell', sets: 3, reps: 3 },
          { name: 'Bulgarian Split Squat', searchQuery: 'bulgarian squat', sets: 3, reps: 8 },
          { name: 'Leg Extension', searchQuery: 'leg extension', sets: 3, reps: 12 },
          { name: 'Hamstring Curl', searchQuery: 'leg curl', sets: 3, reps: 12 },
          { name: 'Calf Raises', searchQuery: 'calf raise', sets: 4, reps: 12 },
          { name: 'Cable Crunch', searchQuery: 'cable crunch', sets: 3, reps: 12 },
        ],
      },
    ],
  },
    ...
    days: [
      {
        ...
        exercises: [
          { name: 'Bench Press', searchQuery: 'barbell bench press', sets: 4, reps: 5 },
          { name: 'Incline Dumbbell Press', searchQuery: 'incline dumbbell press', sets: 3, reps: 8 },
          { name: 'Overhead Shoulder Press', searchQuery: 'barbell overhead press', sets: 3, reps: 6 },
          { name: 'Lateral Raises', searchQuery: 'cable lateral raise', sets: 3, reps: 12 },
          { name: 'Tricep Pushdowns', searchQuery: 'triceps pushdown', sets: 3, reps: 10 },
          { name: 'Overhead Tricep Extension', searchQuery: 'triceps overhead extension', sets: 3, reps: 10 },
        ],
      },
      {
        ...
        exercises: [
          { name: 'Lat Pulldown', searchQuery: 'lat pulldown', sets: 4, reps: 6 },
          { name: 'Bent Over Row', searchQuery: 'bent over barbell row', sets: 3, reps: 6 },
          { name: 'Seated Cable Row', searchQuery: 'cable seated row', sets: 3, reps: 8 },
          { name: 'Face Pulls', searchQuery: 'face pull', sets: 3, reps: 12 },
          { name: 'Barbell Curl', searchQuery: 'barbell curl', sets: 3, reps: 10 },
          { name: 'Hammer Curls', searchQuery: 'hammer curl', sets: 3, reps: 10 },
        ],
      },
      {
      ...
      },
      {
        ...
        exercises: [
          { name: 'Incline Bench Press', searchQuery: 'incline barbell bench press', sets: 3, reps: 8 },
          { name: 'Lat Pulldown', searchQuery: 'lat pulldown', sets: 3, reps: 8 },
          { name: 'Seated Cable Row', searchQuery: 'cable seated row', sets: 3, reps: 10 },
          { name: 'Dumbbell Shoulder Press', searchQuery: 'dumbbell shoulder press', sets: 3, reps: 8 },
          { name: 'Lateral Raises', searchQuery: 'cable lateral raise', sets: 3, reps: 12 },
          { name: 'Bicep Curl', searchQuery: 'barbell curl', sets: 3, reps: 10 },
    ...
    days: [
      {
        ...
        exercises: [
          { name: 'Bench Press', searchQuery: 'barbell bench press', sets: 4, reps: 5 },
          { name: 'Incline Dumbbell Press', searchQuery: 'incline dumbbell press', sets: 3, reps: 8 },
          { name: 'Chest Fly', searchQuery: 'cable fly chest', sets: 3, reps: 10 },
          { name: 'Dips', searchQuery: 'dips', sets: 3, reps: 8 },
          { name: 'Tricep Pushdowns', searchQuery: 'triceps pushdown', sets: 3, reps: 10 },
          { name: 'Overhead Tricep Extension', searchQuery: 'triceps overhead extension', sets: 3, reps: 10 },
        ],
      },
      ...
      },
      {
        ...
        exercises: [
          { name: 'Overhead Press', searchQuery: 'barbell overhead press', sets: 4, reps: 6 },
      ...
      },
      {
        ...
        exercises: [
          { name: 'Incline Dumbbell Press', searchQuery: 'incline dumbbell press', sets: 3, reps: 8 },
          { name: 'Lat Pulldown', searchQuery: 'lat pulldown', sets: 3, reps: 10 },
          { name: 'Lateral Raises', searchQuery: 'cable lateral raise', sets: 3, reps: 15 },
          { name: 'Bicep Curl', searchQuery: 'barbell curl', sets: 3, reps: 12 },
