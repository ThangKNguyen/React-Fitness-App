    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: 'Cable Kneeling Crunch', searchQuery: 'cable kneeling crunch', sets: 3, reps: 12 },
        ],
      },
      {
        label: 'Day 3 – Hypertrophy Focus',
        exercises: [
          { name: 'Straight Leg Deadlift', searchQuery: 'barbell straight leg deadlift', sets: 3, reps: 8 },
          { name: 'Dumbbell Bench Press', searchQuery: 'dumbbell bench press', sets: 3, reps: 8 },
          { name: 'Seated Cable Row', searchQuery: 'cable seated wide-grip row', sets: 3, reps: 10 },
          { name: 'Walking Lunges', searchQuery: 'dumbbell lunge', sets: 3, reps: 10 },
          { name: 'Face Pulls', searchQuery: 'cable rear delt row (with rope)', sets: 3, reps: 12 },
  ...
  },
  {
    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          { name: 'Barbell Squat', searchQuery: 'barbell full squat', sets: 4, reps: 5 },
          { name: 'Straight Leg Deadlift', searchQuery: 'barbell straight leg deadlift', sets: 3, reps: 6 },
    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: 'Seated Cable Row', searchQuery: 'cable seated wide-grip row', sets: 3, reps: 8 },
          { name: 'Face Pulls', searchQuery: 'cable rear delt row (with rope)', sets: 3, reps: 12 },
    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: 'Rear Delt Row', searchQuery: 'dumbbell rear delt row (shoulder)', sets: 3, reps: 12 },
          { name: 'Face Pulls', searchQuery: 'cable rear delt row (with rope)', sets: 3, reps: 12 },
